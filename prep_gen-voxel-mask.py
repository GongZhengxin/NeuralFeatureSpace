...
loc_pool = ['LO1', 'LO2', 'LO3', 'V4t','PIT', 'V8', 'FFC', 'VVC'] #!
# aggregate ROI vertices
roi_name = [__  for _ in [loc_pool] for __ in _] #!
# form ROI mask
...
mask_name = 'loandit-in-MMP' #'primaryvis-in-MMP' #!
...
mapnames.append(mask_name.split('-')[0])
